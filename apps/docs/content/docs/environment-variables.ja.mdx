...
| GitHub | `GITHUB_APP_ID` | Connect、installation identity、PR カードの CI ステータス・マージ可否と「GitHub から選択」リポジトリに必要です |
| GitHub | `GITHUB_APP_PRIVATE_KEY` | App ID と対になる完全な PEM 秘密鍵。用途は同上で、改行を保持します |
